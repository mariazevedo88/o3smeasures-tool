...
public class ResponseForClassVisitor extends ASTVisitor{
	...
	private static int IMETHOD_SIZE = 20;
	private static ResponseForClassVisitor instance;
	
	public ResponseForClassVisitor(){
		super();
		methodsList = new ArrayList<MethodDeclaration>();
		numberMethodCalls = 0d;
		listOfMethodsName = new IMethod[IMETHOD_SIZE];
	}
	...
	public void cleanVariables(){
		...
		this.listOfMethodsName = new IMethod[IMETHOD_SIZE];
	}
}
