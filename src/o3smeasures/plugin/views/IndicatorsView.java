...
import o3smeasures.plugin.chart.BarChart;
...
public class IndicatorsView extends ViewPart {
	...
	public static final String ID = "o3smeasures.plugin.views.IndicatorsView";
	...
	public void showIndicatorChart(ItemMeasured itemMeasured){
		...
		JFreeChart jFreeChart = indicatorsChart.createBarChart(itemMeasured);
