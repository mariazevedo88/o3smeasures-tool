...
import o3smeasures.plugin.chart.BoxAndWhiskerChart;
...
public class FactorsView extends ViewPart {
	...
	public static final String ID = "o3smeasures.plugin.views.FactorsView";
	...
	public void showFactorChart(ItemMeasured itemMeasured){
		...
		JFreeChart jFreeChart = factorsView.createBoxAndWhiskerChart(itemMeasured);
